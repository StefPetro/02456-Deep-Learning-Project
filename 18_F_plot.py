...
axes[0].set_title('Val acc. for model with ancient samples', size=20)
axes[1].set_title('Val loss for model with ancient samples', size=20)
...
axes[0].set_title('Val acc. for model without ancient samples', size=20)
axes[1].set_title('Val loss for model without ancient samples', size=20)
